...
@Component({
  selector: 'app-graph-filter-options',
  templateUrl: './graph-filter-options.component.html',
  styleUrls: ['./graph-filter-options.component.scss']
})
export class GraphFilterOptionsComponent implements OnInit {
